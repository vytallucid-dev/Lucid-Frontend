      ...
      {convertTrade && (
        <AddTradeModal
          ...
          prefill={{
            ...
            planned_entry: convertTrade.planned_entry,
            planned_sl: convertTrade.planned_sl,
            planned_first_tp: convertTrade.planned_first_tp,
            planned_main_tp: convertTrade.planned_main_tp,
