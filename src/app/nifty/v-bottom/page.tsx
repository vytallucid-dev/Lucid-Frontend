  ...
  return (
    <div className="p-4 sm:p-6 space-y-5 max-w-300">
      ...
      <div
        ...
        style={{ background: "rgba(14,20,30,0.4)", borderColor: "rgba(148,163,184,0.06)" }}
      >
        <div className="text-xs font-semibold uppercase tracking-widest mb-3" style={{ color: "#475569" }}>
          When NOT to Use V-Bottom
        </div>
        <p className="text-sm mb-4 font-medium" style={{ color: "#94A3B8" }}>
...
function ThresholdTable({ classification }: { classification: VBottomClassification | null }) {
  return (
    <div className="glass-card p-5">
        ...
        <table className="w-full text-sm" style={{ minWidth: 480 }}>
          <thead>
            <tr style={{ background: "rgba(14,20,30,0.6)" }}>
              ...
              <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider" style={{ color: "#475569" }}>Classification</th>
              <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider" style={{ color: "#475569" }}>Forward Expectation</th>
            </tr>
          </thead>
          <tbody>
            {thresholdRows.map((row) => {
              ...
              return (
                ...
                >
                  <td className="px-4 py-3 font-mono text-sm" style={{ color: "#94A3B8" }}>{row.raw}</td>
                  ...
                  <td className="px-4 py-3 text-sm" style={{ color: "#64748B" }}>{row.expectation}</td>
                  {isActive && <td className="pr-4 text-right text-xs" style={{ color: "#3B82F6" }}>◄ current</td>}
                </tr>
              );
            })}
          </tbody>
      ...
      <div className="mt-4 p-4 rounded-xl text-sm" style={{ background: "rgba(14,20,30,0.5)", color: "#64748B" }}>
        <strong style={{ color: "#94A3B8" }}>Why depth matters:</strong>{" "}
  ...
  return (
    <div className="space-y-5">
      ...
      >
        ...
        <div className="text-5xl font-bold tabular-nums leading-none mb-1" style={{ color: "#E2E8F0" }}>
        ...
        <div className="text-xs mb-4" style={{ color: "#475569" }}>range −14 to +14</div>
        {forward_expectation && (
